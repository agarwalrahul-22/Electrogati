...
<section id="about">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="container" data-aos="zoom-in" data-aos-delay="100" id="salelist_container">
                <?php if ($sales) : ?>
                    ...
                    <div class="card card-body">
                        <Table>
                            <tr>
                                ...
                                <head colspan="2">
                                    <p style="font-size:16px; font-weight:900;"><?= $sale['brand']; ?> :
                                        <?= $sale['model'] ?></p>
        ...
        const getPageData = (filter) => {
            ...
            prevsort = sortby;
            let URL = "http://localhost/mobility/salelisted/getPageData";
            ...
            $.ajax({
                ...
                success: (data, status) => {
                    $("#salelist_container").html(data.view);
